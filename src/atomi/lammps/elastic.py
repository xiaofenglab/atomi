...
def analyze_main(args: argparse.Namespace) -> dict:
    ...
    for t in sorted(by_t):
        ...
        row = {
            ...
            "V_mean_A3": ref.get("md_box", {}).get("volume_A3_mean", ref.get("vol_mean_A3", "")),
            "a_mean_A": ref.get("md_box", {}).get("a_A_mean", ref.get("lx_mean_A", "")),
            "b_mean_A": ref.get("md_box", {}).get("b_A_mean", ref.get("ly_mean_A", "")),
            "c_mean_A": ref.get("md_box", {}).get("c_A_mean", ref.get("lz_mean_A", "")),
            **tensor_components(c),
            **moduli,
