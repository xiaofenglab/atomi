...
STAGES = {
    ...
    "02_continue_relax": StageSpec(
        ...
        description="Continue fixed-cell relaxation only after the metastable fingerprint survives; default cap is NSW=600 so hard f-electron cases are not prematurely stopped.",
        relaxation=True,
        overrides={
            "ISTART": "0",
            "ICHARG": "1",
